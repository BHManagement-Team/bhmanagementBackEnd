...
routes.route('/totalOcc').post((req, res) => {
    mainController.totalOcc(req, res);
})
...
routes.route('/paymentAmounts').post((req, res) => {
    mainController.payment_amount(req, res);
})
...
routes.route('/retrievePaymentByOccID/:id').post((req, res) => {
